...
function showAdminNav() {
  const sideNav = document.getElementById("admin-side-nav");
  const dashboard = document.getElementById("admin-body");
  const buger = document.getElementById("burger-nav");
  const miniNav = document.getElementById("mini-nav");

  sideNav.style.display = "flex";
  dashboard.style.width = "83%";
  buger.classList.remove("display-none");
  miniNav.classList.add("display-none")
...
function hideAdminNav() {
  ...
  buger.classList.add("display-none");
  miniNav.classList.remove("display-none");
    console.log("hello");
    console.log(buger);
}
